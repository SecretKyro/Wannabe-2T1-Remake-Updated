...
public:
	...
	void check_input()
	{
		LeftParentPressed = IsKeyPressed(VK_LEFT);
		RightParentPressed = IsKeyPressed(VK_RIGHT);
		UpPressed = IsKeyPressed(VK_UP);
		DownPressed = IsKeyPressed(VK_DOWN);
		EnterPressed = IsKeyPressed(VK_RETURN);
		BackPressed = IsKeyPressed(VK_BACK);
		OpenClose = IsKeyPressed(VK_F8);
